...
--[[
--Name: LibTouristClassic-1.0 -- #frozn
Name: LibTouristBcc-1.0 -- #frozn
Revision: $Rev: 245 $
...
if (_G["WOW_PROJECT_ID"] ~= _G["WOW_PROJECT_BURNING_CRUSADE_CLASSIC"]) then return end -- #frozn

--local MAJOR_VERSION = "LibTouristClassic-1.0" -- #frozn
local MAJOR_VERSION = "LibTouristBcc-1.0" -- #frozn
